                  ...
                  <div className="space-y-8 animate-fadeIn max-w-3xl mx-auto">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-4 pt-4 border-t border-neutral-800/50 mt-4">
                         ...
                         <button 
                           className="w-8 h-8 rounded-full bg-neutral-900 border border-neutral-800 flex items-center justify-center text-neutral-400 hover:text-amber-500 hover:border-amber-500 transition-all cursor-pointer"
                           onClick={() => {
                             if (navigator.share) {
                               navigator.share({
                                 title: item.title,
                         ...
                         {shareCopied && (
                           <motion.span 
                             ...
                             className="text-amber-500 text-xs font-mono font-bold"
                           >
                             ✓ Copied!
                           </motion.span>
                         )}
